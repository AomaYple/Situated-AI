...
Python 版把上述问题都变成了**可测试的代码**：577 条用例 + 207 条断言核验
（`v3 verify`，其中 `--fast` 跑不需要全库扫描的 188 条），
...
>
> **没有游戏的机器（CI）怎么办**：207 条断言里 36 条能用**入库的离线真值**核验
> （精简快照 33 条 + 官方文档清单 3 条），其余 171 条要读游戏本体，而入库的
