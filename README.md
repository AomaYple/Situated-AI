...
| 项 | 数值 | 说明 |
|---|---:|---|
| 知识库正文总量 | 991,185 字符 | 20 篇主题文档 + 索引 |
| 逐字命中官方原文 | 44,709 个窗口（**4.51%**） | 约相当于官方 217,533 字符语料的 **21%** |
| ├ 代码块内 | 40,829 个（4.12%） | **PDX 语法骨架、字段名、示例模板** —— 与引用 API 签名同类 |
| └ 代码块外 | 3,880 个（**0.39%**，约 3.9K 字符） | 官方 `.md` 里的**英文注释原句**，作为字段语义的依据被引述 |
