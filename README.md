...
231 条数量断言分两处核验：本地跑 `v3 verify`（真值来自游戏本体），
...
游戏升级后的维护因此是两条命令：`v3 tables --write`（表格）+ `v3 verify --fix`（正文数字）。
...
| 项 | 数值 | 说明 |
|---|---:|---|
| 知识库正文总量 | 1,178,849 字符 | 全部 21 篇（20 篇主题文档 + 索引） |
