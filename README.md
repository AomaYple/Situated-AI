...
| 形态 | 命令 | 体积 | 是否入库 |
|---|---|---:|---|
| 完整快照 | `v3 snapshot create` | 约 41 MB | 否（本机深挖用，含 14.5 万条本地化键） |
| **精简快照** | `v3 snapshot create --compact` | 约 5 MB | **是** —— 只留结构域，本地化换成「键数 + sha256」 |
