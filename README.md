...
| 指标 | 值 |
|---|---|
| 测试 | **1616 条**用例（1608 通过 / 8 按条件跳过） |
| 覆盖率 | **88.49%**（`v3 cov` 实测；门禁 86% 由 pyproject 强制 + 再按 11 个核心模块逐条设下限） |
...
| 项 | 数值 | 说明 |
|---|---:|---|
| 知识库正文总量 | 1,296,251 字符 | 全部 21 篇（20 篇主题文档 + 索引） |
