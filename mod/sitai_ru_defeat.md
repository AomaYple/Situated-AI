...
* **档案 id**：`ru_defeat`　**国家**：`RUS`　**游戏版本**：`1.14.4`
...
| 行 | 本地化键 | 为什么是这一行 |
|---|---|---|
| goal | `je_sitai_ru_reform_window_goal` | 第一行 = **当前目标**。写「推过去」而不是「废除农奴制」：改哪条法由 AI 与原版牌池决定，本档案不替它选（§0「让 AI 自己推导」）；写「旧势力拦着的那项」是让玩家知道它为什么一直没动。 |
